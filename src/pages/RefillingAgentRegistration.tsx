          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col items-center text-center">
                <img src="/public/placeholder.svg" alt="Ongoing Job" className="h-16 mb-2" />
                <span className="font-semibold">On-going Job of Fire Extinguisher Refilling</span>
              </div>
              <div className="flex flex-col items-center text-center">
                <img src="/public/placeholder.svg" alt="Trusted Brand" className="h-16 mb-2" />
                <span className="font-semibold">Associate with 2 Decade old Trusted Brand</span>
              </div>
              <div className="flex flex-col items-center text-center">
                <img src="/public/placeholder.svg" alt="Business Opportunity" className="h-16 mb-2" />
                <span className="font-semibold">Regular business & Earning Opportunity</span>
              </div>
              <div className="flex flex-col items-center text-center">
                <img src="/public/placeholder.svg" alt="Mobile Technology" className="h-16 mb-2" />
                <span className="font-semibold">Integrated with Mobile Technology for Smooth Operations</span>
              </div>
              <div className="flex flex-col items-center text-center">
                <img src="/public/placeholder.svg" alt="Updates" className="h-16 mb-2" />
                <span className="font-semibold">Industry Updates & Trends</span>
              </div>
              <div className="flex flex-col items-center text-center">
                <img src="/public/placeholder.svg" alt="Timely Payouts" className="h-16 mb-2" />
