      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-8">
          <div>
            <div className="bg-red-100 border-l-4 border-red-600 p-4 mb-4">
              <div className="font-bold text-red-600 mb-2 flex items-center gap-2">
                <img src="/public/placeholder.svg" alt="Fire Extinguisher For School" className="h-8 w-8 object-contain" />
          ...
          <div className="flex justify-center">
            <img src="/public/placeholder.svg" alt="School Extinguishers" className="rounded shadow max-w-xs" />
          </div>
        </div>
        {/* Buy Online Section */}
