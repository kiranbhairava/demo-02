      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <img src="/public/placeholder.svg" alt="Infrastructure" className="rounded-lg shadow w-full" />
            </div>
            <div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex flex-col items-center">
              <img src="/public/placeholder.svg" alt="Class B Fire Test" className="rounded-lg shadow mb-4 w-full max-w-md" />
              <div className="text-center font-medium mt-2">Class B Watermist 3 ltr. Fire Testing</div>
            </div>
            <div className="flex flex-col items-center">
              <img src="/public/placeholder.svg" alt="Class F Fire Test" className="rounded-lg shadow mb-4 w-full max-w-md" />
