      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-8">
          <div>
            <div className="bg-red-100 border-l-4 border-red-600 p-4 mb-4">
              <div className="font-bold text-red-600 mb-2 flex items-center gap-2">
                <img src="/public/placeholder.svg" alt="Fire Extinguisher For Offices and Shops" className="h-8 w-8 object-contain" />
          ...
          <div className="flex justify-center">
            <img src="/public/placeholder.svg" alt="Offices Extinguishers" className="rounded shadow max-w-xs" />
          </div>
        </div>
        {/* Buy Online Section */}
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row md:justify-between gap-8">
          <div className="flex-1 min-w-[220px] mb-6 md:mb-0">
            ...
            <div className="flex gap-2 mt-4">
              <a href="#"><img src="/public/placeholder.svg" alt="Facebook" className="h-6" /></a>
              <a href="#"><img src="/public/placeholder.svg" alt="LinkedIn" className="h-6" /></a>
              <a href="#"><img src="/public/placeholder.svg" alt="Instagram" className="h-6" /></a>
              <a href="#"><img src="/public/placeholder.svg" alt="Twitter" className="h-6" /></a>
              <a href="#"><img src="/public/placeholder.svg" alt="YouTube" className="h-6" /></a>
            </div>
          </div>
          <div className="flex-1 min-w-[220px] mb-6 md:mb-0">
