          ...
          <div key={cat.title} className="mb-8 flex flex-col md:flex-row md:items-center md:gap-8">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <img src="/public/placeholder.svg" alt={cat.title} className="h-8 w-8 object-contain" />
            ...
            <div className="flex-shrink-0 flex flex-col items-center mt-4 md:mt-0">
              <img src="/public/placeholder.svg" alt={cat.title + ' Extinguishers'} className="rounded shadow max-w-xs" />
            </div>
          </div>
        ))}
        {/* Popular Searches */}
