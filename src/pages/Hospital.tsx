  ...
  return (
    <div className="bg-white w-full">
      ...
      <div className="w-full bg-gray-100 border-b py-2">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <img src="/public/placeholder.svg" alt="Kanex Logo" className="h-12" />
      ...
      <div className="container mx-auto px-4 py-4 text-xs text-gray-500">
        Home &gt; Fire Extinguisher For Hospital & Medical
      </div>

      {/* Main Content */}
      <div className="container mx-auto px-4 py-4">
        <h1 className="text-2xl md:text-3xl font-bold text-red-600 mb-2">Fire Extinguisher For Hospital & Medical</h1>
        <p className="text-gray-700 mb-4 max-w-2xl">Evacuating people safely from a hospital is a more challenging task. Care should be taken to have adequate escape routes from the hospital. Apart from evacuation aids, it must be ensured that sufficient firefighting devices are present in each floor. It's important to buy fire extinguishers that would work for class A, B, and also on C fires. Our fire extinguishers for hospitals range from Clean Agent to ABC Type, ABC Dry Powder to CO2, and even foam type</p>
        <div className="grid md:grid-cols-2 gap-8 items-center mb-8">
          <div>
            <div className="bg-red-100 border-l-4 border-red-600 p-4 mb-4">
              <div className="font-bold text-red-600 mb-2">Fire Extinguisher For Hospital</div>
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div>
                  <div className="mb-1">&gt; Fire Extinguisher For CT Scan Room</div>
                  <div className="mb-1">&gt; Fire Extinguisher For Intensive Care Room</div>
                  <div className="mb-1">&gt; Fire Extinguisher For Hospital Reception Area</div>
                  <div className="mb-1">&gt; Fire Extinguisher For Canteen</div>
                  <div className="mb-1">&gt; Fire Extinguisher For General Operation Theatre</div>
                  <div className="mb-1">&gt; Fire Extinguisher For Genest Room and Diesel Storage</div>
                </div>
                <div>
                  <div className="mb-1">&gt; Fire Extinguisher For Parking Area</div>
                  <div className="mb-1">&gt; Fire Extinguisher For Pharmacy</div>
                  <div className="mb-1">&gt; Fire Extinguisher For Billing Section</div>
                  <div className="mb-1">&gt; Fire Extinguisher For Electrical Panels</div>
                  <div className="mb-1">&gt; Fire Extinguisher For Consultation Rooms</div>
                </div>
              </div>
            </div>
          </div>
          <div className="flex justify-center">
            <img src="/public/placeholder.svg" alt="Hospital Extinguishers" className="rounded shadow max-w-xs" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4 flex flex-col md:flex-row items-center mb-8">
          ...
          <div className="flex items-center ml-4">
            <img src="/public/placeholder.svg" alt="Discount" className="h-16" />
        ...
        <div className="flex flex-wrap justify-between items-center border-t border-b py-4 mb-8 text-xs text-gray-700">
          <div className="flex items-center space-x-2">
            <img src="/public/placeholder.svg" alt="Leading Manufacturer" className="h-8" />
            <span>LEADING MANUFACTURER</span>
          </div>
          <div className="flex items-center space-x-2">
            <img src="/public/placeholder.svg" alt="150+ Products" className="h-8" />
            <span>150+ PRODUCTS</span>
          </div>
          <div className="flex items-center space-x-2">
            <img src="/public/placeholder.svg" alt="Shipping Worldwide" className="h-8" />
            <span>SHIPPING WORLDWIDE</span>
          </div>
          <div className="flex items-center space-x-2">
            <img src="/public/placeholder.svg" alt="Best Customer Service" className="h-8" />
