        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded shadow p-4 flex flex-col items-center">
              ...
              <img src="/public/placeholder.svg" alt="Clean Agent Type" className="h-24 mb-2" />
              <div className="flex flex-wrap justify-center gap-1 mb-2">
                <img src="/public/placeholder.svg" alt="Class A" className="h-6" />
                <img src="/public/placeholder.svg" alt="Class B" className="h-6" />
                <img src="/public/placeholder.svg" alt="Class C" className="h-6" />
                <img src="/public/placeholder.svg" alt="Electrical" className="h-6" />
                <img src="/public/placeholder.svg" alt="CE" className="h-6" />
              </div>
            ...
            <div className="bg-white rounded shadow p-4 flex flex-col items-center">
              ...
              <img src="/public/placeholder.svg" alt="CO2 Type" className="h-24 mb-2" />
              <div className="flex flex-wrap justify-center gap-1 mb-2">
                <img src="/public/placeholder.svg" alt="Class B" className="h-6" />
                <img src="/public/placeholder.svg" alt="Class C" className="h-6" />
                <img src="/public/placeholder.svg" alt="Electrical" className="h-6" />
                <img src="/public/placeholder.svg" alt="ISI" className="h-6" />
              </div>
              <a href="#" className="text-blue-700 text-xs font-semibold mt-2">Know More &gt;&gt;</a>
            </div>
            ...
            <div className="bg-white rounded shadow p-4 flex flex-col items-center">
              ...
              <img src="/public/placeholder.svg" alt="Total Flooding System" className="h-24 mb-2" />
              <a href="#" className="text-blue-700 text-xs font-semibold mt-2">Know More &gt;&gt;</a>
            </div>
            {/* Panel Flooding System */}
            <div className="bg-white rounded shadow p-4 flex flex-col items-center">
              <div className="font-bold text-red-600 text-sm mb-2">Panel Flooding System</div>
              <img src="/public/placeholder.svg" alt="Panel Flooding System" className="h-24 mb-2" />
              <a href="#" className="text-blue-700 text-xs font-semibold mt-2">Know More &gt;&gt;</a>
            </div>
          </div>
        </div>
