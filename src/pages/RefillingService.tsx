  ...
  return (
    <div className="bg-white w-full">
      ...
      <div className="relative w-full h-[350px] md:h-[400px] flex items-center justify-center" style={{background: 'linear-gradient(90deg, #f15a29 0%, #e94e77 100%)'}}>
        <img src="/public/placeholder.svg" alt="Refilling Banner" className="absolute inset-0 w-full h-full object-cover opacity-40" />
      ...
      <div className="container mx-auto px-4 py-8 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex justify-center">
          <img src="/public/placeholder.svg" alt="Why Refilling" className="max-w-xs w-full" />
        </div>
      </div>
      ...
      <div className="w-full py-8" style={{background: 'linear-gradient(90deg, #fbb040 0%, #f15a29 100%)'}}>
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center">
            <img src="/public/placeholder.svg" alt="When Refilling" className="max-w-xs w-full" />
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex justify-center">
          <img src="/public/placeholder.svg" alt="Kanex Refilling" className="max-w-xs w-full" />
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
              <img src="/public/placeholder.svg" alt="Step 1" className="w-28 h-28 object-cover rounded mb-2" />
            ...
            {/* Step 2 */}
            <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
              <img src="/public/placeholder.svg" alt="Step 2" className="w-28 h-28 object-cover rounded mb-2" />
            ...
            {/* Step 3 */}
            <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center">
              <img src="/public/placeholder.svg" alt="Step 3" className="w-28 h-28 object-cover rounded mb-2" />
